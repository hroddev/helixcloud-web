export const siteData = {
    ...
    heroSubtitle: "on Microsoft Azure",
    heroTagline: "Senior DevOps Engineer specializing in scalable Cloud Infrastructure, Infrastructure as Code, and production-grade Optimization.",
    ...
    stackDescription: "The enterprise-grade tools I use to build, secure, and scale modern infrastructure.",
    stackCategories: [
        {
            name: "DevOps & Automation",
            tools: ["Terraform", "Bicep", "Ansible", "PowerShell", "Python"],
        },
        {
            name: "Cloud Platforms",
            tools: ["Microsoft Azure", "AWS", "Microsoft 365", "Entra ID"],
        },
        {
            name: "Containerization & Virtualization",
            tools: ["Docker", "Kubernetes", "VMware", "Serverless", "KVM"],
        },
        {
